                        ...
                        foreach ($dLangs as $Lng) {
                            ...
                            <div class="tab-pane" id="tabs-<?php echo $lID; ?>">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <?php echo InputBox('Title-' . $lID, $d['Title-' . $lID], $_Title); ?>
                                        <?php echo ErrorSpan('Title-' . $lID, $Data['errTitle-' . $lID]); ?>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <?php echo Label('Url-' . $lID, imgFlag($Lng) . $_Url, 'class="col-sm-2 control-label"'); ?>
                                    <div class="col-sm-10">
                                        <?php echo InputBox('Url-' . $lID, $d['Url-' . $lID], $_Url); ?>
                                        <?php echo ErrorSpan('Url-' . $lID, $Data['errUrl-' . $lID]); ?>
                                    </div>
                                </div>
                                <div class="form-group">
