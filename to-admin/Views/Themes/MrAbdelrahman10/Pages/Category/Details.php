                    ...
                    <div class="tab-content">
                        ...
                        foreach ($dLangs as $Lng) {
                            ...
                            <div class="tab-pane" id="tabs-<?php echo $lID; ?>">
                                <div class="formRow">
                                    <label><?php echo imgFlag($Lng) . $_Category; ?></label>
                                    <?php echo $d['Name-' . $lID]; ?>
                                </div>
                                <div class="formRow">
                                    <label><?php echo imgFlag($Lng) . $_Alias; ?></label>
                                    <?php echo $d['Alias-' . $lID]; ?>
                                </div>
                                <div class="formRow">
                                ...
                                <div class="formRow">
                                    <label><?php echo imgFlag($Lng) . $_Keywords; ?></label>
                                    <?php echo $d['Keywords-' . $lID]; ?>
                                </div>
