    ...
    <form method="POST" enctype="multipart/form-data" id="form" class="form-horizontal" role="form">
                        ...
                        foreach ($dLangs as $Lng) {
                            ...
                            <div class="tab-pane" id="tabs-<?php echo $lID; ?>">
                                <div class="form-group">
                                    <?php
                                    echo Label('Name-' . $lID, imgFlag($Lng) . $_Name
        ...
        <div class="col-md-3">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        <?php echo Label('Parent', $_ParentCategory, 'class="col-sm-12 control-label"'); ?>
                        <div class="col-sm-12">
                            <?php echo DropDown('Parent', $dCategoriesList, $d['ParentID']); ?>
