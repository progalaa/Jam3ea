        ...
        <div class="col-md-4">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <?php echo Label('Instagram', $_Instagram, 'class="col-sm-5 control-label"'); ?>
                        <div class="col-sm-7">
                            <?php echo InputBox('Instagram', $d['Instagram'], $_Instagram); ?>
                            <?php echo ErrorSpan('Instagram', $errInstagram); ?>
                        </div>
                    </div>
