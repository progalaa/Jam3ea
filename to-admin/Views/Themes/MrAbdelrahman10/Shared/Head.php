...
<script src="<?php echo APP_PUBLIC; ?>bootstrap/third-party/bootstrap-daterangepicker-master/daterangepicker.js" type="text/javascript"></script>
...
<!--<link href="<?php echo ADM_URL; ?>Plugins/cleditor/jquery.cleditor.css" rel="stylesheet" type="text/css"/>
<script src="<?php echo ADM_URL; ?>Plugins/cleditor/jquery.cleditor.min.js"></script>-->

<script src="<?php echo ADM_URL; ?>Plugins/ckeditor/ckeditor.js"></script>
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#btnSelectAll').click(function () {
            ...
            if ($('#btnSelectAll').hasClass('btn-success')) {
                ...
                $('#btnSelectAll').removeClass('btn-success').addClass('btn-inverse').html('<i class="fa fa-remove icon-white"></i><?php echo $_DeSelectAll ?>');
            } else {
                for (i = 0; i < chks.length; i++) {
                    var chk = chks[i];
                    if (chk.type == 'checkbox') {
                ...
                $('#btnSelectAll').removeClass('btn-inverse').addClass('btn-success').html('<i class="fa fa-ok icon-white"></i><?php echo $_SelectAll ?>');
            }
        });
    });
    ...
    function mCheck(rID) {
        var dID = document.getElementById("C-" + rID);
        var dIDs = document.getElementById("Permission");
        if (dID.checked === true) {
            dIDs.value += rID + ",";
        } else if (dID.checked === false) {
            dIDs.value = dIDs.value.replace(rID + ",", "");
        }
        /*var i = dIDs.value.lastIndexOf(",");
         var l = dIDs.value.length;
         var s = dIDs.value;
         if (i == l - 1) {
         dIDs.value = s.substr(0, l - 1);
         }*/
    }
</script>