var swfobject = function() {
    ...
    function M(a) {
        if (typeof m.addEventListener != i)
            m.addEventListener("load", a, !1);
        else if (typeof d.addEventListener != i)
            d.addEventListener("load", a, !1);
        else if (typeof m.attachEvent != i)
            U(m, "onload", a);
    ...
    function J(a, b, c) {
        ...
        if (g)
            if (typeof a.id == i && (a.id = c), e.ie && e.win) {
                var o = "", h;
                for (h in a)
                    a[h] != Object.prototype[h] && ("data" == h.toLowerCase() ? b.movie = a[h] : "styleclass" == h.toLowerCase() ? o += ' class="' + a[h] + '"' : "classid" != h.toLowerCase() && (o += " " +
                            h + '="' + a[h] + '"'));
                h = "";
                for (var j in b)
                ...
                for (o in b)
                    b[o] != Object.prototype[o] && "movie" != o.toLowerCase() &&
    ...
    function Q(a, b, c, f) {
        if (!e.ie || !e.mac) {
            ...
            if (g) {
                ...
                f && (K = l = null);
                if (!l || K != c)
                    f = d.createElement("style"), f.setAttribute("type", "text/css"), f.setAttribute("media", c), l = g.appendChild(f),
    ...
    var i = "undefined", r = "object", y = "application/x-shockwave-flash",
        ...
        if (typeof q.plugins != i && typeof q.plugins["Shockwave Flash"] ==
                r) {
            if ((h = q.plugins["Shockwave Flash"].description) && !(typeof q.mimeTypes != i && q.mimeTypes[y] && !q.mimeTypes[y].enabledPlugin))
                T = !0, g = !1, h = h.replace(/^.*\s+(\S+\s+\S+$)/, "$1"), e[0] = parseInt(h.replace(/^(.*)\..*$/, "$1"), 10), e[1] = parseInt(h.replace(/^.*\.(.*)\s.*$/, "$1"), 10), e[2] = /[a-zA-Z]/.test(h) ? parseInt(h.replace(/^.*[a-zA-Z]+(.*)$/, "$1"), 10) : 0
    ...
    return{registerObject: function(a, b, c, f) {
            ...
            e.w3 && !(e.wk && 312 > e.wk) && a && b && c && d && g ? (t(b, !1), L(function() {
                ...
                if (h && typeof h === r)
                    for (var q in h)
                        l.flashvars = typeof l.flashvars != i ? l.flashvars + ("&" + q + "=" + h[q]) : q + "=" + h[q];
                if (z(g))
                    p = J(e, l, b), e.id ==
                            b && t(b, !0), n.success = !0, n.ref = p;
                else {
                    if (o && F()) {
                        e.data = o;
                        G(e, l, b, m);
