 ...
 */
        (function() {
            ...
            CKEDITOR.env || (CKEDITOR.env = function() {
                var b = navigator.userAgent.toLowerCase(), c = window.opera, a = {ie: eval("/*@cc_on!@*/false"), opera: !!c && c.version, webkit: b.indexOf(" applewebkit/") > -1, air: b.indexOf(" adobeair/") > -1, mac: b.indexOf("macintosh") > -1, quirks: document.compatMode == "BackCompat", mobile: b.indexOf("mobile") > -1, iOS: /(ipad|iphone|ipod)/.test(b), isCustomDomain: function() {
                        ...
                        return a != b && a != "[" + b + "]"
                            ...
                            "https:"};
                a.gecko = navigator.article == "Gecko" && !a.webkit && !a.opera;
                if (a.webkit)
            ...
            (function() {
                ...
                CKEDITOR.tools = {arrayCompare: function(a, b) {
                        ...
                        if (a === null || typeof a != "object" || a instanceof
                                String || a instanceof Number || a instanceof Boolean || a instanceof Date || a instanceof RegExp)
                            return a;
                        b = new a.constructor;
                        for (e in a)
                            b[e] = this.clone(a[e]);
                        ...
                        if (typeof(e = arguments[b - 1]) == "boolean")
                            b--;
                        ...
                        for (var a = [].concat(a), b, e = [], c = 0; c < a.length; c++)
                            if (b = a[c])
                                / @import | [{}] / .test(b) ? e.push("<style>" + b + "</style>") : e.push('<link type="text/css" rel=stylesheet href="' + b + '">');
                        return e.join("")
            ...
            (function() {
                function b(a) {
                    for (var b = 0, e = 0, d = c[a].length; e < d; e++)
                ...
                CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {type: CKEDITOR.NODE_ELEMENT, addClass: function(a) {
                    ...
                    hasAttributes: CKEDITOR.env.ie && (CKEDITOR.env.ie7Compat || CKEDITOR.env.ie6Compat) ? function() {
                        ...
                        function a(a, b, c) {
                            if (b && b.type == CKEDITOR.NODE_ELEMENT) {
                                ...
                                if (a.isIdentical(b)) {
                                    for (var k = c ? a.getLast() : a.getFirst(); g.length; )
                                        g.shift().move(a, !c);
                                    b.moveChildren(a, !c);
                                    b.remove();
                        ...
                        if (h < 0 || g > 0)
                            m(0, b === true ? h : b === false ? g : h < 0 ? h : g);
                        if (c && (k < 0 || d > 0))
                            m(k < 0 ? k : d, 0)
                    ...
                    copyAttributes: function(a, b) {
                        for (var c = this.$.attributes, b = b || {}, d = 0; d < c.length; d++) {
                            ...
                            if (!(k in b))
                                if (k == "checked" && (h = this.getAttribute(k)))
                                    a.setAttribute(k, h);
                ...
                function b(a, b) {
                    ...
                    if (this.current)
                        ...
                        if (a)
                            ...
                            d = n;
                            if (d.type == CKEDITOR.NODE_ELEMENT && !(d = d.getChild(o)))
                                d = j(n, true) === false ? null : n.getNextSourceNode(true, f, j)
                        }
                        d && j(d) === false && (d = null)
                    }
                    for (; d && !this._.end; ) {
            ...
            (function() {
                ...
                var f = function(a) {
                    ...
                    for (var u = l, r, D, v, t = h; t < f.length; t++) {
                        ...
                        for (r = r.getNext(); r; ) {
                            if (r.equals(i[t]) || r.equals(g))
                                break;
                            v = r.getNext();
                            if (b == 2)
                                u.append(r.clone(true));
                            else {
                                r.remove();
                                b == 1 && u.append(r)
                            }
                    ...
                    for (l = h; l < i.length; l++) {
                        ...
                        if (!f[l] || r.$.parentNode != f[l].$.parentNode)
                            for (r = r.getPrevious(); r; ) {
                                if (r.equals(f[l]) || r.equals(d))
                                    break;
                                v = r.getPrevious();
                                if (b == 2)
                                    u.$.insertBefore(r.$.cloneNode(true), u.$.firstChild);
                                else {
                                    r.remove();
                ...
                CKEDITOR.dom.range.prototype = {clone: function() {
                        ...
                        switch (a) {
                            ...
                            case CKEDITOR.ENLARGE_ELEMENT:
                                ...
                                for (; i || e; ) {
                                    if (i && !e) {
                                        !h && i.equals(j) && (h = true);
                                        if (c ? i.isBlockBoundary() : !d.contains(i))
                                            break;
                        ...
                        if (!this.collapsed) {
                            ...
                            j.guard = function(b, j) {
                                if (m(b))
                                    return true;
                                if (a == CKEDITOR.SHRINK_ELEMENT && b.type == CKEDITOR.NODE_TEXT || j && b.equals(p) || c === false && b.type == CKEDITOR.NODE_ELEMENT && b.isBlockBoundary())
                                    return false;
                                !j && b.type == CKEDITOR.NODE_ELEMENT && (p = b);
                                return true
                            };
                            if (k)
                                (d = j[a == CKEDITOR.SHRINK_ELEMENT ? "lastForward" :
            ...
            (function() {
                ...
                b.prototype = {getNextParagraph: function(b) {
                        ...
                        for (this._.nextNode = null; j; ) {
                            ...
                            if (z)
                                j.type == CKEDITOR.NODE_TEXT && a.test(j.getText()) && (z = 0);
                            else {
                                var s = j.getName();
                        ...
                        if (!e) {
                            ...
                            q = {div: 1, th: 1, td: 1};
                            e = e.block;
                            if (!e && j && !this.enforceRealBlocks && q[j.getName()] && h.checkStartOfBlock() && h.checkEndOfBlock() && !j.equals(h.root))
                                e = j;
                                ...
                                this._.nextNode = e.equals(n) ? null : c(h.getBoundaryNodes().endNode, 1, n)
                        }
                        if (o)
                            (h = e.getPrevious()) && h.type == CKEDITOR.NODE_ELEMENT && (h.getName() == "br" ? h.remove() : h.getLast() && h.getLast().$.nodeName.toLowerCase() == "br" && h.getLast().remove());
                        if (l)
                            (h = e.getLast()) && h.type == CKEDITOR.NODE_ELEMENT && h.getName() == "br" && (CKEDITOR.env.ie || h.getPrevious(f) || h.getNext(f)) && h.remove();
                        if (!this._.nextNode)
                            this._.nextNode = m ||
            ...
            CKEDITOR.resourceManager.prototype = {add: function(b, c) {
                    ...
                    CKEDITOR.scriptLoader.load(d, function(b,
                            l) {
                        if (l.length)
                            throw'[CKEDITOR.resourceManager.load] Resource name "' + g[l[0]].join(",") + '" was not found at "' + l[0] + '".';
                    ...
                    var d = {}, g = function(a) {
                        b.call(this, a, function(a) {
                            ...
                            for (k in a) {
                                ...
                                if (!c[k]) {
                                    if (o.icons)
                                        for (var j = o.icons.split(","), q = 0; q < j.length; q++)
                                            CKEDITOR.skin.addIcon(j[q], o.path + "icons/" + j[q] + ".png");
                                    c[k] = 1
                                }
                                if (l) {
                                    l.split && (l = l.split(","));
                ...
                function b(b, j, o) {
                    ...
                    if (j !== void 0) {
                        if (j instanceof CKEDITOR.dom.element) {
                            if (!o)
                                throw Error("One of the element mode must be specified.");
                        } else
                            throw Error("Expect element of type CKEDITOR.dom.element.");
                        if (CKEDITOR.env.ie && CKEDITOR.env.quirks && o == CKEDITOR.ELEMENT_MODE_INLINE)
                        ...
                        if (o == CKEDITOR.ELEMENT_MODE_INLINE && !j.is(CKEDITOR.dtd.$editable) || o == CKEDITOR.ELEMENT_MODE_REPLACE &&
                                j.is(CKEDITOR.dtd.$nonBodyContent))
                            throw Error('The specified element mode is not supported on element: "' + j.getName() + '".');
                        this.element = j;
                        this.elementMode = o;
                    ...
                    CKEDITOR.plugins.load(c.split(","), function(c) {
                        ...
                        for (var f in c) {
                            ...
                            if (h && !a.lang[f]) {
                                ...
                                if (!i.langEntries || !i.langEntries[q])
                                    e.push(CKEDITOR.getUrl(i.path + "lang/" + q + ".js"));
                                else {
                                ...
                                for (; ; ) {
                                    ...
                                    if (!o.isUnknown && !i.isUnknown && !e[d])
                                        if (i.isOptionalClose)
                                            ...
                                            i = g
                                        } else if (d in CKEDITOR.dtd.$listItem && !l(d, g))
                                            j.onTagOpen(d == "li" ? "ul" : "dl", {}, 0, 1);
            ...
            (function() {
                function b(b, c) {
                        ...
                        return function(l) {
                            if (l.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                                ...
                                if (e = CKEDITOR.env.opera && !b || (typeof c == "function" ? c(l) !== false : c))
                                    if (!t && CKEDITOR.env.ie && l.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT)
                                        e = false;
                                    else if (!t && CKEDITOR.env.ie && (document.documentMode > 7 || l.name in CKEDITOR.dtd.tr || l.name in CKEDITOR.dtd.$listItem))
                                        e = false;
                                    else {
                                        e = a(l);
                    ...
                    function j(a, b) {
                        if ((!t || !CKEDITOR.env.ie) && a.type == CKEDITOR.NODE_ELEMENT && a.name == "br" && !a.attributes["data-cke-eol"])
                            return true;
                        var c;
                        if (a.type ==
                            ...
                            if (CKEDITOR.env.ie && t && (!b || a.parent.name in h))
                                return true;
                            if (!t)
                    ...
                    for (q in h)
                        "#"in B[q] || delete h[q];
                    for (q in h)
                        i.elements[q] = l(t, b.config.fillEmptyBlocks !== false);
                    i.root = l(t);
                ...
                var s = /(?:&nbsp;|\xa0)$/, A = "{cke_protected}", B = CKEDITOR.dtd, p = ["caption", "colgroup", "col", "thead", "tfoot",
                    "tbody"], E = CKEDITOR.tools.extend({}, B.$blockLimit, B.$block), u = {elements: {}, attributeNames: [[/^on/, "data-cke-pa-on"]]}, r = {elementNames: [[/^cke:/, ""], [/^\?xml:namespace$/, ""]], attributeNames: [[/^data-cke-(saved|pa)-/, ""], [/^data-cke-.*/, ""], ["hidefocus", ""]], elements: {$: function(a) {
                            var b = a.attributes;
                            if (b) {
                                if (b["data-cke-temp"])
                                    return false;
                    ...
                    $: function(a, b) {
                        ...
                        this.setup()
                            ...
                            if (!b) {
                                var f = /\n{2}/g;
                                if (f.test(a))
                                    var g = "<" + c + ">", i = "</" + c + ">", a = g + a.replace(f, function() {
                                    return i + g
                                }) + i
                            }
                            a = a.replace(/\n/g, "<br>");
                            ...
                            for (var c =
                                ...
                                if (!n.checkReadOnly()) {
                                    ...
                                    var E, u;
                                    if (i)
                                        for (; (E = n.getCommonAncestor(0, 1)) && (u = CKEDITOR.dtd[E.getName()]) && (!u || !u[m]); )
                                            if (E.getName()in CKEDITOR.dtd.span)
                                                ...
                                                n.splitBlock(e == CKEDITOR.ENTER_DIV ? "div" : "p",
                                                        c.editable());
                                    n.insertNode(k);
                                    B || (B = k)
                                }
                            ...
                            if (B) {
                                ...
                                if (i)
                                    if ((b = B.getNext(a)) && b.type == CKEDITOR.NODE_ELEMENT && b.is(CKEDITOR.dtd.$block))
                                        b.getDtd()["#"] ? n.moveToElementEditStart(b) : n.moveToElementEditEnd(B);
                ...
                var n = function() {
                    ...
                    function c(a, d) {
                        ...
                        for (var h = i[h.getName()], m = 0, n = a.getChildren(), q = n.count(), k = -1, z = -1, y = 0, s = e.contains(i.$list); m < q; ++m) {
                            ...
                            if (b(e)) {
                                ...
                                t.push({isElement: 0, node: e, allowed: 1})
                        }
                        if (k > -1)
                            t[k].firstNotAllowed = 1;
                        if (z > -1)
                            t[z].lastNotAllowed = 1;
                        return t
                    }
                    function d(a, c) {
                    ...
                    return function(m, s, u) {
                        ...
                        if (!D.checkReadOnly()) {
                            ...
                            for (; (C = b(r.startContainer) && r.startContainer.getChild(r.startOffset - 1)) && b(C) && C.isBlockBoundary() && I.contains(C); )
                                r.moveToPosition(C, CKEDITOR.POSITION_BEFORE_END);
                            ...
                            for (t = w.startNode; (t = t.getParent()) && e(t); )
                                v.push(t);
                            r.moveToBookmark(w);
                            if (u) {
                                C = u;
                                ...
                                if ((K = u.startPath().block) && !(K.getChildCount() == 1 && K.getBogus()))
                                    a:{
                                        var F;
            ...
            (function() {
                ...
                CKEDITOR.on("instanceCreated", function(a) {
                    ...
                    f.on("contentDom", function() {
                        ...
                        if (l.isInline() ? CKEDITOR.env.webkit || CKEDITOR.env.gecko : CKEDITOR.env.opera) {
                            ...
                            l.attachListener(l, "mouseup", c, f);
                        if (CKEDITOR.env.webkit)
                ...
                CKEDITOR.dom.selection = function(a) {
                    ...
                    if (a)
                        if (a.getRangeAt)
                            d = (c = a.rangeCount && a.getRangeAt(0)) && new CKEDITOR.dom.node(c.commonAncestorContainer);
                        else {
                            try {
                                c = a.createRange()
                            } catch (e) {
                ...
                CKEDITOR.dom.selection.prototype = {getNative: function() {
                        ...
                        if (!c || !c.rangeCount)
                            ...
                            if (d == c.endContainer && d.nodeType == 1 && c.endOffset -
                                    c.startOffset == 1 && n[d.childNodes[c.startOffset].nodeName.toLowerCase()])
                                b = CKEDITOR.SELECTION_ELEMENT
                        }
                        return a.type = b
                    }, getRanges: function() {
                        var a = m ? function() {
                            ...
                            var b = function(b, c) {
                                ...
                                e = h.text.replace(/(\r\n|\r)/g, "\n").length;
                                if (!e)
                                    return{container: d, offset: a(g) + (k > 0 ? 0 : 1)};
                                for (; e > 0; )
                                    try {
                        ...
                        var b = this, c = CKEDITOR.tools.tryThese(function() {
                            return b.getNative().createRange().item(0)
                                ...
                                function() {
                                    for (var a = b.getRanges()[0], c, d, e = 2; e && (!(c = a.getEnclosedNode()) || !(c.type == CKEDITOR.NODE_ELEMENT && n[c.getName()] && (d = c))); e--)
                        ...
                        if (this.isLocked) {
                            ...
                            this.reset();
                            if (a)
                                (a = b || c[0].getCommonAncestor()) && a.getAscendant("body", 1) && (b ? this.selectElement(b) : this.selectRanges(c))
                        }
                    }, reset: function() {
                        this._.cache = {}
                        ...
                        if (a.length)
                            if (this.isLocked) {
                                ...
                                if (m) {
                                    ...
                                    if (A && A.type == CKEDITOR.NODE_ELEMENT && A.getName()in n && (!A.is("a") || !A.getText()))
                                        try {
                                    ...
                                    for (e = 0; e < a.length; e++) {
                                        ...
                                        if (b.collapsed && CKEDITOR.env.webkit && f(b)) {
                                            ...
                                            if ((h = i.getNext()) && !i.getPrevious() && h.type == CKEDITOR.NODE_ELEMENT &&
                                                ...
                                                b.moveToPosition(i, CKEDITOR.POSITION_AFTER_END)
                                        }
                                        k.setStart(b.startContainer.$, b.startOffset);
                                        try {
            ...
            (function() {
                                ...
                                for (var g = y(this, c), q = g.hasAttributes(), s = o.getCommonAncestor(), p = {}, r = {}, u = {}, z = {}, A, B, E; g && s; ) {
                                    if (s.getName() == d) {
                                        for (A in e.attributes)
                                            if (!z[A] && (E = s.getAttribute(B)))
                                                g.getAttribute(A) == E ? r[A] = 1 : z[A] = 1;
                                        for (B in e.styles)
                                            if (!u[B] && (E = s.getStyle(B)))
                                                g.getStyle(B) == E ? p[B] = 1 : u[B] = 1
                                    }
                                    s = s.getParent()
                                }
                                for (A in r)
                ...
                function k(a, b) {
                    ...
                    if (d && !e) {
                        ...
                        f ? b = n(c ? [a.getHtml()] : h(a), b) : a.moveChildren(b);
                    b.replace(a);
                    if (d) {
                        var c = b, j;
                ...
                function l(a) {
                    for (var b = s(this), c = a.getElementsByTag(this.element), d = c.count(); --d >= 0; )
                        o.call(this, c.getItem(d));
                    for (var e in b)
                        if (e != this.element) {
                                ...
                                if (k && a.length > 1) {
                                    if (!d)
                                        for (var h = a.length - 1; h >= 0; h--)
                                            c.unshift(a[h].createBookmark(true));
                                    if (g)
                                        for (var m = 0; a[d + m + 1]; ) {
                                            for (var n = k.document, g = 0, h = n.getById(c[m].endNode), n = n.getById(c[m +
                                                ...
                                                if (n.equals(h))
                                                    g = 1;
                                                else if (b(h) || h.type == CKEDITOR.NODE_ELEMENT && h.isBlockBoundary())
                                                    continue;
                                                break
                                            }
                                            if (!g)
                        ...
                        select: function(b, a, d) {
                            if (!(3 > arguments.length)) {
                                ...
                                CKEDITOR.ui.dialog.labeledElement.call(this, b, a, d, function() {
                                    ...
                                    p(c);
                                    for (var j = 0, k; j < a.items.length && (k = a.items[j]); j++)
                                        i.push('<option value="', CKEDITOR.tools.htmlEncode(k[1] !== void 0 ? k[1] : k[0]).replace(/"/g, "&quot;"), '" /> ', CKEDITOR.tools.htmlEncode(k[0]));
            ...
            (function() {
                ...
                CKEDITOR.dialog.prototype = {destroy: function() {
                    ...
                    commitContent: function() {
                        ...
                        for (d = e.getChild(); e =
                                d.shift(); )
                            g[e.id] = e, "function" == typeof e.getChild && d.push.apply(d, e.getChild());
                ...
                var G, w = {}, r, t = {}, M = function(a) {
                    ...
                    for (var b in t) {
                        for (var c = t[b], e = c.length - 1; 0 <= e; e--)
                ...
                CKEDITOR.ui.dialog.uiElement.prototype = {getElement: function() {
                        ...
                        return this
                    }, eventProcessors: {onLoad: function(a,
                                b) {
                            a.on("load", b, this)
                        }, onShow: function(a, b) {
                            a.on("show", b, this)
            ...
            (function() {
                ...
                CKEDITOR.plugins.add("dialogadvtab", {requires: "dialog", createAdvancedTab: function(c, a) {
                        ...
                        var b = c.lang.common, g = {id: "advanced", label: b.advancedTab,
                            title: b.advancedTab, elements: [{type: "vbox", padding: 1, children: []}]}, d = [];
                        if (a.id || a.dir)
                            a.id && d.push({id: "advId", att: "id", type: "text", label: b.id, setup: e, commit: f}), a.dir && d.push({id: "advLangDir", att: "dir", type: "select", label: b.langDir, "default": "", style: "width:100%", items: [[b.notSet, ""], [b.langDirLTR, "ltr"], [b.langDirRTL, "rtl"]], setup: e, commit: f}), g.elements[0].children.push({type: "hbox", widths: ["50%", "50%"], children: [].concat(d)});
                        if (a.styles || a.classes)
                            d = [], a.styles && d.push({id: "advStyles", att: "style",
                                type: "text", label: b.styles, "default": "", validate: CKEDITOR.dialog.validate.inlineStyle(b.invalidInlineStyle), onChange: function() {
                                    ...
                                    "55%"], children: [{id: "advCSSClasses", att: "class", type: "text", label: b.cssClasses, "default": "", setup: e, commit: f}]}), g.elements[0].children.push({type: "hbox", widths: ["50%", "50%"], children: [].concat(d)});
                        return g
                    }})
            })();
            ...
            (function() {
                        ...
                        refresh: function(a, d) {
                            ...
                            if (c && c.length) {
                                for (var h = {}, e = d.createBookmarks(), c = c.createIterator(), g, j = 0; g = c.getNextRange(1); ) {
                                    ...
                                    g = g.createIterator();
                                    for (g.enlargeBr = b !=
                                            CKEDITOR.ENTER_BR; i = g.getNextParagraph(b == CKEDITOR.ENTER_P?"p":"div"); )
                                        n(i, a, f, h)
                                }
                ...
                for (var j = CKEDITOR.dom.element.prototype,
                        l = ["setStyle", "removeStyle", "setAttribute", "removeAttribute"], k = 0; k < l.length; k++)
            ...
            (function() {
                function v(b) {
                    ...
                    function k(a, c) {
                        ...
                        if (!d.getById("cke_pastebin")) {
                            ...
                            setTimeout(function() {
                                ...
                                i.remove();
                                var a;
                                if (CKEDITOR.env.webkit && (a = i.getFirst()) && a.is && a.hasClass("Apple-style-span"))
                                    i = a;
                    ...
                    function n(a) {
                        ...
                        if ("Paste" == a) {
                            ...
                            a = b.getSelection(), c = a.getRanges(), c = a.type != CKEDITOR.SELECTION_NONE && !(1 == c.length && c[0].collapsed);
                ...
                function x(b, a) {
                    ...
                    if ((CKEDITOR.env.gecko || CKEDITOR.env.opera) && b.enterMode != CKEDITOR.ENTER_BR)
                        CKEDITOR.env.gecko && (a = a.replace(/^<br><br>$/, "<br>")), -1 < a.indexOf("<br><br>") && (a = "<p>" +
                ...
                CKEDITOR.plugins.add("clipboard", {requires: "dialog", init: function(b) {
                        ...
                        b.on("paste", function(a) {
                            ...
                            if (b.match(/^<[^<]+cke_(editable|contents)/i)) {
                                ...
                                for (g.setHtml(b); 1 == g.getChildCount() && (h = g.getFirst()) && h.type == CKEDITOR.NODE_ELEMENT && (h.hasClass("cke_editable") || h.hasClass("cke_contents")); )
                                    g = l = h;
            ...
            (function() {
                ...
                CKEDITOR.ui.button.prototype = {render: function(b, e) {
                        ...
                        var c = {id: i, button: this, editor: b, focus: function() {
                            ...
                            if (c.onkey)
                                return b = new CKEDITOR.dom.event(b), !1 !== c.onkey(c, b.getKeystroke())
            ...
            CKEDITOR.plugins.add("colorbutton", {requires: "panelbutton,floatpanel", init: function(c) {
                    function j(k, i, e, g) {
                        ...
                        c.ui.add(k, CKEDITOR.UI_PANELBUTTON, {label: e, title: e, modes: {wysiwyg: 1}, editorFocus: 1, toolbar: "colors," + g, panel: {css: CKEDITOR.skin.getPath("editor"), attributes: {role: "listbox", "aria-label": f.panelTitle}}, onBlock: function(b, a) {
                                ...
                                do
                                    a = b && b.getComputedStyle("back" == i ? "background-color" : "color") || "transparent";
                            ...
                            a.addCommand("removediv", {exec: function(a) {
                                    function b(c) {
                                        if ((c = CKEDITOR.plugins.div.getSurroundDiv(a,
                                                c)) && !c.data("cke-div-added"))
                                            f.push(c), c.data("cke-div-added")
                                    }
                                    for (var e = a.getSelection(), g = e && e.getRanges(), d, i = e.createBookmarks(), f = [], c = 0; c < g.length; c++)
                                        d = g[c], d.collapsed ? b(e.getStartElement()) : (d = new CKEDITOR.dom.walker(d), d.evaluator = b, d.lastForward());
            ...
            (function() {
                function w(a) {
                    ...
                    function h() {
                        var b = {}, c, f, d;
                        for (c in a.ui.items)
                            f = a.ui.items[c], d = f.toolbar || "others", d = d.split(","), f = d[0], d = parseInt(d[1] || -1, 10), b[f] || (b[f] = []), b[f].push({name: c, order: d});
                        for (f in b)
                            b[f] = b[f].sort(function(a,
                                    b) {
                        ...
                        var e, h = function(c, d) {
                            ...
                            switch (d) {
                                ...
                                case CKEDITOR.SHIFT + 9:
                                    for (; !b || !b.items.length; )
                                        if (b = 9 == d ? (b ? b.next : c.toolbar.next) || a.toolbox.toolbars[0] : (b ? b.previous : c.toolbar.previous) || a.toolbox.toolbars[a.toolbox.toolbars.length -
                                                1], b.items.length)
                                            for (c = b.items[e?b.items.length - 1:0]; c && !c.focus; )
                                                (c = e ? c.previous : c.next) || (b = 0);
                                    c && c.focus();
                                    return!1;
                                case g ? 37 : 39:
                                case 40:
                                    b = c;
                                    do
                                        b = b.next, !b && f && (b = c.toolbar.items[0]);
                                    while (b && !b.focus);
                                    b ? b.focus() : h(c, 9);
                                    return!1;
                                case g ? 39 : 37:
                                case 38:
                                    b = c;
                                    do
                                        b = b.previous, !b && f && (b = c.toolbar.items[c.toolbar.items.length - 1]);
                                    while (b && !b.focus);
                        ...
                        a.on("uiSpace", function(c) {
                            if (c.data.space ==
                                ...
                                for (var o = a.toolbox.toolbars, n = w(a), l = 0; l < n.length; l++) {
                                    var j, i = 0, q, m = n[l], r;
                                    if (m)
                                        if (f && (g.push("</span>"), e = f = 0), "/" === m)
                                            g.push('<span class="cke_toolbar_break"></span>');
                                        else {
                                            r = m.items || m;
                                            for (var s = 0; s < r.length; s++) {
                                                ...
                                                if (!(b && 0 <= CKEDITOR.tools.indexOf(b, k)) && (k = a.ui.create(k)))
                                                    if (k.type == CKEDITOR.UI_SEPARATOR)
                                                        e = f && k;
                                                    else {
                                                        u = !1 !== k.canGroup;
                                                        if (!i) {
                                ...
                                if (r[d.root.getName()]) {
                                    ...
                                    if (!(1 > g.length)) {
                                        ...
                                        for (p = e = void 0; g.length; )
                                            e = g.shift(), p = b.createElement("li"), e.is("pre") || G.test(e.getName()) ? e.appendTo(p) : (e.copyAttributes(p), d && e.getDirection() &&
            ...
            (function() {
                function p(d, i) {
                    ...
                    if (this.useIndentClasses = d.config.indentClasses && 0 < d.config.indentClasses.length) {
                        ...
                        this.indentClassMap = {};
                        for (var a = 0; a < d.config.indentClasses.length; a++)
                            this.indentClassMap[d.config.indentClasses[a]] = a + 1
                    }
                ...
                p.prototype = {context: "p", refresh: function(d, i) {
                        ...
                        function i(n) {
                            for (var h = l.startContainer, b = l.endContainer; h && !h.getParent().equals(n); )
                                h = h.getParent();
                            for (; b && !b.getParent().equals(n); )
                                b = b.getParent();
                            if (h && b) {
                                for (var c = h, h = [], a = !1; !a; )
                                    c.equals(b) && (a = !0), h.push(c), c = c.getNext();
                                if (!(1 > h.length)) {
                                    c = n.getParents(!0);
                                    for (b = 0; b < c.length; b++)
                                    ...
                                    if ("outdent" == e.name) {
                                        ...
                                        if ((j = n.getParent()) && j.is("li"))
                                            for (var c = h.listNode.getChildren(), f = [], g, b = c.count() - 1; 0 <= b; b--)
                                                (g = c.getItem(b)) && (g.is && g.is("li")) && f.push(g)
                                    }
                                    h && h.listNode.replace(n);
                                    if (f && f.length)
                                        for (b = 0; b < f.length; b++) {
                                            for (g = n = f[b]; (g = g.getNext()) && g.is && g.getName()in m; )
                        ...
                        for (var e = this, o = {}, g = d.getSelection(), v = g.createBookmarks(1), l, p = (g && g.getRanges(1)).createIterator(); l = p.getNextRange(); ) {
                            for (var j =
                                    l.getCommonAncestor(); j && !(j.type == CKEDITOR.NODE_ELEMENT && m[j.getName()]); )
                                j = j.getParent();
                            if (!j) {
            ...
            (function() {
                ...
                function n(a, c) {
                    ...
                    if (!("function" == typeof c && !1 === c.call(this._.filebrowserSe)) && !(e && !1 === e.call(this._.filebrowserSe, a, c)) && ("string" == typeof c && c && alert(c), a && (b = this._.filebrowserSe, d = b.getDialog(), b = b.filebrowser.target || null)))
                        if (b =
                                b.split(":"), e = d.getContentElement(b[0], b[1]))
                ...
                CKEDITOR.plugins.add("flash", {requires: "dialog,fakeobjects", onLoad: function() {
                    ...
                    init: function(a) {
                        ...
                        a.contextMenu && a.contextMenu.addListener(function(a) {
                            if (a &&
                                    a.is("img") && !a.isReadOnly() && "flash" == a.data("cke-real-element-type"))
            ...
            (function() {
                ...
                CKEDITOR.env.gecko && function() {
                    ...
                    if (a) {
                        ...
                        window.addEventListener("load", arguments.callee, !1)
                }()
            })();
            ...
            CKEDITOR.removeAnchorCommand.prototype = {exec: function(b) {
                    ...
                    if (a && (d = a.getSelectedElement()) && (CKEDITOR.plugins.link.fakeAnchor && !d.getChildCount() ? CKEDITOR.plugins.link.tryRestoreFakeAnchor(b, d) : d.is("a")))
                        d.remove(1);
                    else if (d = CKEDITOR.plugins.link.getSelectedLink(b))
                        d.hasAttribute("href") ? (d.removeAttributes({name: 1, "data-cke-saved-name": 1}), d.removeClass("cke_anchor")) : d.remove(1);
                    a.selectBookmarks(c)
                }};
            ...
            (function() {
                var g, i = {modes: {wysiwyg: 1, source: 1}, canUndo: !1, readOnly: 1, exec: function(a) {
                        ...
                        if (b.fullPage)
                            a = a.getData().replace(/<head>/, "$&" + e).replace(/[^>]*(?=<\/title>)/, "$& &mdash; " + a.lang.preview.preview);
                        else {
                ...
                CKEDITOR.plugins.add("stylescombo", {requires: "richcombo", init: function(b) {
                        function j(a) {
                            b.getStylesSet(function(g) {
                                if (!i.length) {
                                    for (var c, l, e = 0, f = g.length; e < f; e++)
                                        c = g[e], b.blockless && c.element in CKEDITOR.dtd.$block || (l = c.name, c = h[l] = new CKEDITOR.style(c), c._name = l, c._.enterMode = k.enterMode, i.push(c));
                                    i.sort(m)
                                }
                                a && a()
                            })
                        ...
                        b.ui.addRichCombo("Styles", {label: f.label, title: f.panelTitle, toolbar: "styles,10", panel: {css: [CKEDITOR.skin.getPath("editor")].concat(k.contentsCss), multiSelect: !0, attributes: {"aria-label": f.panelTitle}}, init: function() {
                                ...
                                j(function() {
                                    var a, g, c, b, e, h;
                                    e = 0;
                                    for (h = i.length; e < h; e++)
                                        a = i[e], g = a._name, b = a.type, b != c && (d.startGroup(f["panelTitle" + b]), c = b), d.add(g, a.type == CKEDITOR.STYLE_OBJECT ? g : a.buildPreview(), g);
                                    d.commit()
                                })
                            }, onClick: function(a) {
                                b.focus();
            ...
            (function() {
                            ...
                            for (f.guard = d; g = f.next(); )
                                if (g.type != CKEDITOR.NODE_ELEMENT || !g.is(CKEDITOR.dtd.table))
                                    if ((g =
                                        ...
                                        CKEDITOR.dom.element.setMarker(a, g, "selected_cell", !0), b.push(g)
                        }
                    }
                ...
                function n(c, d) {
                    for (var b = o(c), a = b[0].getAscendant("table"), e = q(b, 1), b = q(b), e = d ? e : b, f = CKEDITOR.tools.buildTableMap(a), a = [], b = [], g = f.length, h = 0; h < g; h++)
                        a.push(f[h][e]), b.push(d ? f[h][e - 1] : f[h][e + 1]);
                    for (h = 0; h < g; h++)
                        a[h] &&
                ...
                function s(c) {
                    if (c instanceof CKEDITOR.dom.selection) {
                        ...
                        a:{
                            ...
                            b = c.length - 1;
                            for (var e = {}, f, g; f = c[a++]; )
                                CKEDITOR.dom.element.setMarker(e, f, "delete_cell", !0);
                            for (a = 0; f = c[a++]; )
                        ...
                        c instanceof CKEDITOR.dom.element && (d = c.getParent(), 1 == d.getChildCount() ? d.remove() : c.remove())
                }
                function u(c, d) {
                    var b = new CKEDITOR.dom.range(c.getDocument());
                    if (!b["moveToElementEdit" + (d ? "End" : "Start")](c))
                        b.selectNodeContents(c), b.collapse(d ? !1 : !0);
                    b.select(!0)
                }
                function v(c, d, b) {
                    c = c[d];
                    ...
                    for (d = 0; c && d < c.length; d++) {
                        if (b.is && c[d] == b.$)
                            return d;
                        if (d == b)
                            return new CKEDITOR.dom.element(c[d])
                    }
                    return b.is ? -1 : null
                }
                function r(c, d, b) {
                    var a = o(c),
                            e;
                    if ((d ? 1 != a.length : 2 > a.length) || (e = c.getCommonAncestor()) && e.type == CKEDITOR.NODE_ELEMENT && e.is("table"))
                        return!1;
                    var f, c = a[0];
                    ...
                    for (var d =
                        ...
                        if (!b) {
                            ...
                            if (f.getChildren().count()) {
                                if (n != m && s && (!s.isBlockBoundary || !s.isBlockBoundary({br: 1})))
                    ...
                    a = b.count();
                    for (d = a - 1; 0 <= d; d--)
                        e = b.getItem(d), e.$.cells.length || (e.remove(), a++);
                    return c
                }
                function x(c, d) {
                    var b = o(c);
                ...
                function y(c, d) {
                    ...
                    if (1 < g)
                        a = Math.ceil(g / 2), g = Math.floor(g / 2);
                    else {
                ...
                CKEDITOR.plugins.tabletools = {requires: "table,dialog,contextmenu", init: function(c) {
                        ...
                        c.addCommand("columnDelete", d({exec: function(a) {
                                for (var a = a.getSelection(), a = o(a), b = a[0], c = a[a.length - 1], a = b.getAscendant("table"), d = CKEDITOR.tools.buildTableMap(a), h, i, j = [], k = 0, m = d.length; k < m; k++)
                                    for (var l = 0, n = d[k].length; l < n; l++)
                                        d[k][l] == b.$ && (h = l), d[k][l] == c.$ && (i = l);
                                for (k = h; k <= i; k++)
            ...
            (function() {
                ...
                i.prototype = {equals: function(a, c) {
                        ...
                        d = a.bookmarks;
                        if (b || d) {
                            if (!b || !d || b.length != d.length)
                                return!1;
                            for (var e = 0; e < b.length; e++) {
                                var g = b[e], f = d[e];
                                if (g.startOffset != f.startOffset || g.endOffset != f.endOffset || !CKEDITOR.tools.arrayCompare(g.start, f.start) || !CKEDITOR.tools.arrayCompare(g.end, f.end))
                                    return!1
                            }
                        }
                        return!0
