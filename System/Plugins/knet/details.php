...
<table width="100%" border="0" cellpadding="1" cellspacing="1" class="text">
  ...
  <tr>
    <td class="tdwhite">
	<form action="https://www.jm3eia.com/System/Plugins/knet/buy.php" method="post">
      ...
      <table width="70%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC">
        <tr>
          ...
          <td width="80%" class="tdwhite"><input type="text" value="Abderahman" name="name" length="30"></td>
        </tr>
        <tr>
          <td class="tdfixed"><strong>Address:</strong></td>
          <td class="tdwhite"><input type="text" name="address" value="Malaysia" length="30"></td>
        </tr>
        <tr>
          <td class="tdfixed"><strong>Postal Code:</strong></td>
          <td class="tdwhite"><input type="text" name="postal" value="53100" length="30"></td>
        </tr>
        <tr>
          <td class="tdwhite"></td>
